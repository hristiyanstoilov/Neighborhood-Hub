...
export const skills = pgTable(
  ...
  (t) => [
    ...
    index('skills_title_trgm_idx').using('gin', sql`${t.title} gin_trgm_ops`),
...
export const tools = pgTable(
  ...
  (t) => [
    ...
    index('tools_title_trgm_idx').using('gin', sql`${t.title} gin_trgm_ops`),
...
export const foodShares = pgTable(
  ...
  (t) => [
    ...
    index('food_shares_title_trgm_idx').using('gin', sql`${t.title} gin_trgm_ops`),
